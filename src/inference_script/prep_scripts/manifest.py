...
def main(args):
    ...
    local_arr.extend(Parallel(n_jobs = args.jobs)( delayed(read_file)(fname, args, dir_path) for fname in tqdm(glob.iglob(search_path, recursive=True))))  # noqa: E251,E501,E201
    ...
    # Saving Training Manifest File  # noqa: E303,E266
    ...
    if len(valid_samples) != 1:
        with open(os.path.join(args.dest, args.valid_name +  ".tsv"), "w+") as valid_f:  # noqa: E222
